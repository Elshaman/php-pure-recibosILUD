...
class codigoBarras {
    ...
    function codigoBarras($configuracion) {
        ...
        //$this->fuenteSimbolo=$configuracion[0].$configuracion[1]."Vera.ttf";
        //$this->fuenteSimbolo="C:\AppServ\www\fuentes\Vera.ttf";


        $this->fuenteSimbolo = $configuracion[0] . $configuracion[1] . "Vera.ttf";
        //echo  $this->fuenteSimbolo;
    }

    //end funcion codigoBarras
...
//end funcion ean128
    ...
    function code128($codigoBarra, $escala=1, $archivo="") {
        ...
        //imagettfbbox (escala, 0, Fuente, Mensaje)
        //$font_arr=imagettfbbox ( $escala*10, 0, "Tahoma.ttf", $codigoBarra);
...
//end funcion codificacionean128
}

//end class codigoBarras
?>